...
////
//func (this *BaseService) InsertModels(model interface{}) (int, error) {
//	var value = reflect.ValueOf(model)
//	if value.Kind() == reflect.Ptr || value.Kind() == reflect.Interface {
//		value = value.Elem()
//	}
//	if value.Kind() == reflect.Struct {
//		return this.DB.insertStruct("", value)
//	}
...
////
//func (this *BaseService) InsertModels2(table string, model interface{}) (int, error) {
//	var value = reflect.ValueOf(model)
//	if value.Kind() == reflect.Ptr || value.Kind() == reflect.Interface {
//		value = value.Elem()
//	}
...
////
//func (this *BaseService) insertStruct(table string, value reflect.Value) (int, error) {
//	if table == "" {
...
////
//func (this *BaseService) insertSlice(table string, value reflect.Value) error {
