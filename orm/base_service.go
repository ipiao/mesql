...
// Query 解析查询条件，结果赋予models
func (this *BaseService) Exec() *medb.Result {
	return this.DB.Exec(this.GetCondition(), this.GetValues()...)
}
...
// SetDateGe 设置起始日期
func (this *BaseService) SetTimeGe(key string, value interface{}) *BaseService {
...
// SetDateGe 设置起始日期
func (this *BaseService) SetTimeLe(key string, value interface{}) *BaseService {
	this.setCondtion(key, "`"+key+"` <= ? ")
	this.setValue(value)
	return this
}
...
// SetDateGe 设置起始日期
func (this *BaseService) SetTimeGt(key string, value interface{}) *BaseService {
	this.setCondtion(key, "`"+key+"` > ? ")
	this.setValue(value)
	return this
}
...
// SetDateGe 设置起始日期
func (this *BaseService) SetTimeLt(key string, value interface{}) *BaseService {
	this.setCondtion(key, "`"+key+"` < ? ")
	this.setValue(value)
	return this
}
...
// SetDateLe 设置结束日期
func (this *BaseService) SetDateBetween(key string, start interface{}, end interface{}) *BaseService {
	this.setCondtion(key, " and to_days(`"+key+"`) between to_days(?) and to_days(?)")
